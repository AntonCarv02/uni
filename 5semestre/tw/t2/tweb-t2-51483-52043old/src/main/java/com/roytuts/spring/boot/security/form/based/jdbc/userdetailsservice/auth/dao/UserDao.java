...
public class UserDao {
    ...
    public User getUser(final String username) {
        try {
            return jdbcTemplate.queryForObject(
                    "select u.user_name user_name, u.user_pass user_pass, user_email, ur.user_role user_role from app_user u, my_user_role ur where u.user_name = ? and u.user_name = ur.user_name",
    ...
    public List<String> getUsernameList() {
        return jdbcTemplate.queryForList("select my_user_name FROM user", String.class);
    }
